...
test("Heading renders an h1 with text", () => {
  ...
  const heading = shallow(<Heading>{headingText}</Heading>)
...
test("Heading modifier is added as heading BEM class", () => {
  const heading = shallow(<Heading modifiers={["test"]}>Heading</Heading>)
...
test("Heading level 2 uses an h2 tag", () => {
  const heading = shallow(<Heading level={2}>Heading</Heading>)
...
test("Heading level 6 uses an h6 tag", () => {
  const heading = shallow(<Heading level={6}>Heading</Heading>)
...
test("Heading level 0 uses a span tag", () => {
  const heading = shallow(<Heading level={0}>Non-semantic Heading</Heading>)
